...
def generate_next_story(intent):
    ...
    if not user_initial_story:
        return "Please add the initial story first.", ""
...
with gr.Blocks() as demo:
    ...
    add_initial_story_btn.click(add_initial_story, inputs=initial_story_input, outputs=[accumulated_output, initial_story_input])
    generate_next_story_btn.click(generate_next_story, inputs=intent_input, outputs=[accumulated_output, initial_story_input])
    save_story_btn.click(save_story, outputs=accumulated_output)
